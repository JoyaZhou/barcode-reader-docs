...
5. Add code for barcode scanning
   ...
   ```objc
    ...
    - (void)viewDidLoad {
         [super viewDidLoad];
         //7 days public trial key is available for every new device that have never activated Dynamsoft Barcode Reader.
         //Please visit: https://www.dynamsoft.com/customer/license/trialLicense?product=dbr&utm_source=docs&package=ios to request for 30 days extension.
         //Replace the organizationID with your own organizationID to activate the license
         ...
         dbr = [[DynamsoftBarcodeReader alloc] initLicenseFromLTS:dbrPara verificationDelegate:self];
   ...
   class ViewController: UIViewController {
      override func viewDidLoad() {
         ...
         do {
            ...
            /*7 days public trial key is available for every new device that have never activated Dynamsoft Barcode Reader.
            Please visit: https://www.dynamsoft.com/customer/license/trialLicense?product=dbr&utm_source=docs&package=ios to request for 30 days extension.
            Replace the organizationID 200001 with your own organizationID to activate the license*/
...
iDMLTSConnectionParameters* dbrPara = [[iDMLTSConnectionParameters alloc] init];
dbrPara.organizationID = @"Put your organizationID here";
barcodeReader = [[DynamsoftBarcodeReader alloc] initLicenseFromLTS:dbrPara verificationDelegate:self];
